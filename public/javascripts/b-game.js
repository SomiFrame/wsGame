...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Class_Material = __webpack_require__(1);

	var _Class_Material2 = _interopRequireDefault(_Class_Material);

	var _Class_Tubing = __webpack_require__(2);

	var _Class_Tubing2 = _interopRequireDefault(_Class_Tubing);
...
/***/ function(module, exports) {
	...
	var Class_Material = function () {
	    function Class_Material(canvas) {
	    ...
	    _createClass(Class_Material, [{
	        key: 'setMoveSpeed',
	        value: function setMoveSpeed(speedX, speedY) {
	            this.speedX = speedX || this.speedX;
	            this.speedY = speedY || this.speedY;
	        }
	    }, {
	        key: 'clearAll',
	        value: function clearAll(pen) {
	            pen.clearRect(0, 0, this.canvas.width, this.canvas.height);
	        }
	    }, {
	        key: 'draw',
	        value: function draw(pen) {
	            pen.beginPath();
	...
	exports.default = Class_Material;
...
/***/ function(module, exports) {
	...
	var Class_Tubing = function () {
	    function Class_Tubing(canvas) {
	        var x = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
	        var y = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
	        var width = arguments[3];
	        var intervalHeight = arguments[4];
	        var gv = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : .4;
	        var color = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '#000000';

	        _classCallCheck(this, Class_Tubing);
